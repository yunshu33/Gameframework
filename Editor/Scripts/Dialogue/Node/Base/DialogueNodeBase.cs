...
namespace LJVoyage.Game.Editor.Dialogue
{
    public abstract class DialogueNodeBase : UnityEditor.Experimental.GraphView.Node, ISetData<NodeScriptableObjectBase>
    {
        ...
        public NodeScriptableObjectBase Data
        {
        ...
        public abstract Port CreateInputPort(Orientation orientation, Direction direction, Port.Capacity capacity,
            Type type);

        public abstract Port CreateOutputPort(Orientation orientation, Direction direction, Port.Capacity capacity,
            Type type);
